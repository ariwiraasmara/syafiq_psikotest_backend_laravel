                ...
                <div id="form">
                    <form action="{{ route('admin_login') }}" method="POST">
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-4 justify-self-center">
                            ...
                            <button type="button" class="btn p-2 border-2 border-white bg-pink-700 hover:bg-pink-500 text-white rounded-lg text-center" onclick="window.location.href= '{{ route('home') }}'">
                                Kembali
                            </button>
                        </div>
                    </form>
