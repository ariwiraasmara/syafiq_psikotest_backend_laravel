...
@section('content')
    ...
    <div class="p-4 text-black" style="margin-bottom: 0px;">
        ...
        <div class="">
            <form action="{{ route('admin_anggota_simpan') }}" method="POST">
                @csrf()
                <input type="hidden" id="unique" name="unique" value="{{ $unique }}" readonly />
                
                <input  type="text" id="txt-name" name="name" required
                        placeholder="Nama..." label="Nama..."
                        class="p-2 w-full block shadow-xl rounded-lg text-white"
                        style="background-color: rgba(0, 0, 0, 0.5)"
                />
                <span class="font-bold italic text-red-700">* wajib</span>

                <input  type="email" id="txt-email" name="email" required
                ...
                <input  type="number" id="txt-no_identitas" name="no_identitas" required
                ...
                <div class="mt-4">
                    ...
                    <input type="radio" id="roles-su" name="roles" value="1" required />
                    <label for="roles-su">Super Admin</label>

                    <input type="radio" id="roles-ad" name="roles" value="2" required />
                ...
                <div class="mt-4">
                    ...
                    <input type="radio" id="jk-p" name="jk" value="Pria" required />
                    <label for="jk-p">Pria</label>

                    <input type="radio" id="jk-w" name="jk" value="Wanita" required />
                ...
                <div class="mt-4">
                    ...
                    <input  type="file" id="txt-foto" name="foto"
                            placeholder="Foto..." label="Foto..."
                            class="p-2 w-full block shadow-xl rounded-lg text-white"
                            style="background-color: rgba(0, 0, 0, 0.5)"
                    />
                </div>
                ...
                <textarea id="alamat" name="alamat"
                        class="mt-4 p-2 w-full block shadow-xl rounded-lg text-white"
                        style="background-color: rgba(0, 0, 0, 0.5)"></textarea>
