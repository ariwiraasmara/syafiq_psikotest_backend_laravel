        ...
        <div class="">
            <form action="{{ route('admin_blog_store') }}" method="POST">
                ...
                <div class="">
                    ...
                    <input type="radio" id="status-draft" name="status" value="draft" class="ml-2 form-radio" required onclick="isDate('status-draft')" /> <label for="status-draft" class="">Draft</label>
                    <input type="radio" id="status-public" name="status" value="public" class="ml-4 form-radio" required onclick="isDate('status-public')" /> <label for="status-public" class="">Publikasikan</label>
                </div>
                ...
                <div id="isdate" class="mt-4">
                    ...
                    <input type="datetime-local" id="txt-date" name="tgl_publikasi" class="w-full block shadow-xl p-2 bg-white rounded-lg text-black"  />
                </div>
