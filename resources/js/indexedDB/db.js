...
const getPertanyaan = async () => {
    try {
        ...
        const response = await axios.get(`/api/indexedDB/psikotest/kecermatan/pertanyaan`, {
            withCredentials: true,  // Mengirimkan cookie dalam permintaan
            headers: {
...
const getSoalJawaban = async () => {
    try {
        ...
        const response = await axios.get(`/api/indexedDB/psikotest/kecermatan/soaljawaban`, {
            withCredentials: true,  // Mengirimkan cookie dalam permintaan
            headers: {
                'XSRF-TOKEN': csrfToken,
                'Content-Type': 'application/json',
