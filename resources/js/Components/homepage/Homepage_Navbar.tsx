...
export default function Homepage_Navbar(props: Homepage_Navbar) {
    ...
    const handleClick_MenuPeserta = (event: any) => {
        setAnchorPeserta(event.currentTarget);
      };

    const handleClose_MenuPeserta = (e: any) => {
        e.preventDefault();
        setAnchorPeserta(null);
    }

    const toPeserta = (e: any) => {
        e.preventDefault();
        setAnchorPeserta(null);
        try {
    ...
    const handleOpenModal_HasilPsikotestKecermatanPeserta = (e: any) => {
        e.preventDefault();
        setOpenModal_HasilPsikotestKecermatanPeserta(true);
    }
    
    const handleCloseModal_HasilPsikotestKecermatanPeserta = (e: any) => {
        e.preventDefault();
        setOpenModal_HasilPsikotestKecermatanPeserta(false);
        setAnchorPeserta(null);
    }

    const onSubmit_HasilPsikotestKecermatanPeserta = (e: any) => {
        e.preventDefault();
        try {
            localStorage.setItem('ispeserta', 'true');
