...
namespace App\Http\Controllers\View\Layanan\PsikotesSIM;
use Inertia\Inertia;
...
class Page extends Controller {
    ...
    public function __construct(
        ...
        $this->titlepage = 'Layanan Psikotes SIM'.$this->brand->getTitlepage();
        ...
        if($request->session()->has('id')) {
            ...
            $this->activity->store([
                ...
                'deskripsi'  => 'read : data halaman layanan psikotes sim.',
    ...
    public function reactView(Request $request): Inar|Response|JsonResponse|Collection|array|String|int|null {
        ...
        return Inertia::render('layanan/psikotes_sim/page', [
    ...
    public function bladeView(Request $request): View|Response|JsonResponse|Collection|array|String|int|null {
        return view('pages.layanan.psikotes_sim.page', [
            'title'                => $this->titlepage,
            'pathURL'              => url()->current(),
            'breadcrumb'           => '/',
