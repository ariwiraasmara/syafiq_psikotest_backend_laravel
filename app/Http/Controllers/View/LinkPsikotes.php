...
class LinkPsikotes extends Controller{
    //
    ...
    public function __construct(
        ...
        $this->titlepage = 'Link Psikotes'.$this->brand->getTitlepage();
        ...
        if($request->session()->has('id')) {
            ...
            $this->activity->store([
                ...
                'deskripsi'  => 'read : halaman link psikotes.',
    ...
    public function reactView(Request $request): Inar|Response|JsonResponse|Collection|array|String|int|null {
        ...
        return Inertia::render('link_psikotes/page', [
    ...
    public function bladeView(Request $request): View|Response|JsonResponse|Collection|array|String|int|null {
        return view('pages.link_psikotes', [
            'title'                => $this->titlepage,
            'pathURL'              => url()->current(),
            'breadcrumb'           => '/',
