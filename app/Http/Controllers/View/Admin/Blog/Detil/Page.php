...
// ! All Rights Reserved
namespace App\Http\Controllers\View\Admin\Blog\Detil;
use Inertia\Inertia;
...
class Page extends Controller {
    ...
    public function __construct(
        ...
        // ?
        $this->titlepage = 'Blog Detil | Admin'.$this->brand->getTitlepage();
        ...
        $this->activity->store([
            ...
            'deskripsi'  => 'read : melihat data blog detil.',
    ...
    public function reactView(Request $request): Inar|Response|JsonResponse|Collection|array|String|int|null {
        ...
        return Inertia::render('admin/blog/detil/page', [
    ...
    public function bladeView(Request $request, $id): View|Response|JsonResponse|Collection|array|String|int|null {
        ...
        return view('pages.admin.blog.detil.page', [
            'title'                => $this->titlepage,
            'appbar_title'         => 'Blog Detil',
            'pathURL'              => url()->current(),
            'breadcrumb'           => '/',
